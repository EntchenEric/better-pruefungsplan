...
export default function Home() {
  return (
    ...
    <div className="font-sans min-h-screen bg-secondary text-primary">
      ...
      <div className="px-6 py-8 text-center max-w-2xl mx-auto">
        <div className="bg-primary backdrop-blur-sm rounded-lg shadow-sm border border-theme p-6">
          ...
          <p className="text-base text-secondary-text mb-6 leading-relaxed">
            Bitte schreibe{" "}
            <span
              className="text-primary-text hover:text-primary-text font-semibold 
