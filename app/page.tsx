        ...
        <div className="px-6 py-8 text-center max-w-xl mx-auto w-full">
          ...
          >
            ...
            <p className="mt-[18px] text-base text-secondary-text leading-relaxed mb-[22px] px-[2vw] md:px-[16%] opacity-[92%]">
              Der Quellcode dieser Webseite ist öffentlich zugänglich! Wenn du
              ihn erkunden oder sogar mithelfen möchtest, findest du alles im
              Repository.
            </p>
        ...
        <div className="px-6 py-8 text-center max-w-xl mx-auto w-full">
          ...
          >
            ...
            <p className="mt-[18px] text-base text-secondary-text leading-relaxed mb-[22px] opacity-[92%]">
              ...
              verarbeitet werden. Da PDFs schwierig zu verarbeiten sind, ist das
              leichter gesagt als getan. Aufgrund eines ziemlich komplexen
              Verarbeitungsvorgangs (welcher nicht eleganter möglich ist) können
              sich Fehler einschleichen. Es ist zwar bis jetzt nicht vorgekommen
              dass Informationen falsch sind, aber better safe than sorry. Falls
              du einen Fehler bemerkst, melde diesen bitte umgehend.
            </p>
          </div>
        </div>
      </div>
