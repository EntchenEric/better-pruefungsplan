    ...
    <>
      <div className="px-6 py-8 text-center max-w-xl mx-auto w-full">
        <div
          ...
          <h3 className="text-xl font-bold text-theme-primary mb-[10px] tracking-wide drop-shadow-sm">Quellcode</h3>
          <a
          ...
          <div className="flex flex-col gap-y-px items-center justify-center mt-auto pt-4 border-t border-theme-light">
            <a href="https://github.com/EntchenEric/better-pruefungsplan/issues/new" target="_blank" rel='noopener noreferrer'
              title='Bug melden'
              className="
                mt-[2px]
            ...
            <a href='https://github.com/EntchenEric/better-pruefungsplan/discussions' target='_blank' rel='noopener noreferrer'
...
export default function Home() {
  return (
    ...
    <div className="font-sans min-h-screen bg-secondary text-primary">
      <Suspense fallback={<div className="flex justify-center items-center min-h-screen"><div className="text-lg text-primary-text">Loading...</div></div>}>
        <ExamScheduleViewer />
      </Suspense>
          ...
          <div className="bg-primary/80 backdrop-blur-md rounded-xl shadow-lg border border-theme p-8">
            ...
            <div className="border-t border-theme-light pt-4 mt-4">
              <p className="text-xs text-secondary-text leading-relaxed italic opacity-80">
                Diese Website ist <strong>nicht</strong> in Zusammenarbeit mit der Westfälischen Hochschule entstanden und steht in <strong>keinem</strong> offiziellen Zusammenhang mit der Hochschule.
              </p>
            </div>
          </div>
          <InfoCards />
