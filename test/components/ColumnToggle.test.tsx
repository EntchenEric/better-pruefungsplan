  ...
  describe('User Interactions', () => {
    ...
    it('calls onToggleColumn with correct key for each column', () => {
      ...
      checkboxes.forEach((checkbox, index) => {
        ...
        expect(mockOnToggleColumn).toHaveBeenCalledWith(TABLE_HEADERS[index].key);
      });
  ...
  describe('Component Structure', () => {
    ...
    it('generates unique keys for each toggle element', () => {
      ...
      TABLE_HEADERS.forEach(({ key }) => {
        const labelElement = container.querySelector(`label[key="toggle-${key}"]`);
  ...
  describe('Edge Cases', () => {
    it('handles empty TABLE_HEADERS gracefully', () => {
      ...
      const originalHeaders =
        jest.requireMock('../../config/tableConfig').TABLE_HEADERS;
