...
describe('/app/api/exams/route', () => {
  ...
  describe('GET /api/exams', () => {
    ...
    it('should handle missing PdfReader from pdfreader module', async () => {
      ...
      await expect(GET()).rejects.toThrow('Failed to load PdfReader from "pdfreader" (CJS interop)');
    });
  });
  ...
  describe('validation functions', () => {
    ...
    describe('validateField', () => {
      ...
      it('should validate pruefungsform field correctly', () => {
        ...
        expect(validateField('pruefungsform', 'Muendliche Pruefung')).toBe(true);
      ...
      it('should validate semester fields correctly', () => {
        const semesterFields = ['pi_ba', 'ti_ba', 'mi_ba', 'wi_ba', 'pi_ba_dual', 
                               'ti_ba_dual', 'mi_ba_dual', 'wi_ba_dual', 'pi_ma', 
                               'ti_ma', 'mi_ma', 'wi_ma', 'is_ma'];
  ...
  describe('mergePages function', () => {
    ...
    it('should merge pages when count exceeds 5', () => {
      const mockPages = Array(10).fill(null).map((_, i) => [
        { text: `Page${i}`, x: 10, y: 20 }
      ]);
    ...
    it('should process a complete realistic PDF scenario', async () => {
      ...
      const mockPdfReader = {
        parseBuffer: jest.fn((buffer, callback) => {
          ...
          const headers = ['mid', 'kuerzel', 'po', 'lp', 'datum', 'zeit', 'pruefungsform', 
                          'pruefungsdauer', 'modul', 'pruefer', 'pruefer_name', 'zweitpruefer',
